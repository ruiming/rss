...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('feed/feed_tpl.html', '<div class="post-panel"><div class="sidebar list-group"><a class="post-select list-group-item" ng-repeat="post in vm.posts" ui-sref="feed.post({id: post.feed_id, post_id: post._id})"><h2>{{post.title}}</h2><span>{{post.pubdate | toLocalString}}</span></a></div><div ui-view class="center"><div class="page-header"><h1>{{vm.feed.title}}</h1></div><feed-panel feed="vm.feed"></feed-panel><div class="container-fluid"><div class="row"><div class="col-md-6 graphy"><p>更新频率图,最近一段时间的每天更新文章数，柱状图表示</p></div><div class="col-md-6 graphy"><p>用户阅读图，最近一段时间的阅读情况和阅读时间图标</p></div></div></div></div></div>');

  $templateCache.put('home/home_tpl.html', '<div class="container-fluid"><div class="row"><div class="col-md-8"><div class="col-md-12 graphy"><p>用户阅读情况</p></div><div class="col-md-12 graphy"><p>最新公告</p></div></div><div class="col-md-4"><div class="col-md-12 graphy"><p>订阅源推荐</p></div></div></div></div>');
