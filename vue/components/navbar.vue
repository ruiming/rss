<template>
    ...
    <ul class="list-group">
        <router-link :to="{name: 'home'}"><span class="icon-book"><small>未读</small></span></router-link>
        ...
        <router-link :to="{name: 'square'}"><span class="icon-pacman"><small>广场</small></span></router-link>
    </ul>
</div>
</template>
